          ...
          <div className="mt-10 md:mt-16">
            <div className="md:max-w-3xl m-auto">
              <details className="border-b-2">
                <summary className="p-4 text-gray-800 font-montserrat font-bold cursor-pointer pt-5 mb-1 text-2xl focus:text-blue-700">
              ...
              <details className="border-b-2">
                <summary className="p-4 font-montserrat text-gray-800 font-bold cursor-pointer pt-5 mb-1 text-2xl focus:text-blue-700">
